                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-5 d-flex flex-column justify-content-center p-4 text-white"
                                ...
                                <div class="position-absolute w-100 h-100"
                                    style="top:0; left:0; background: url('{{ asset('images/pattern.png') }}'); opacity: 0.05;">
                                </div>
                                ...
                                <div class="position-relative z-index-1 text-dark">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:4422121210" class="text-dark small font-weight-bold"
                                                style="text-decoration: none;">(442) 212 1210</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:contacto@rentimaq.com" class="text-dark small font-weight-bold"
                                                style="text-decoration: none;">contacto@rentimaq.com</a>
                                        </div>
                                    </div>

                                    <div class="mt-4">
                                        <h6 class="font-weight-bold mb-2 icon-label" style="font-size: 0.9rem;">Síguenos
                                        </h6>
                                        <div class="d-flex">
                                            <a href="https://web.facebook.com/Rentimaq-Qro-101847991428233/" target="_blank"
                                                class="social-btn mr-2" title="Facebook">
                                                <img src="{{ asset('images/facebook.svg') }}" alt="Facebook"
                                                    style="width: 20px; height: 20px;">
                                            </a>
                                            <a href="https://www.instagram.com/rentimaq_qro/" target="_blank"
                            ...
                            <div class="col-md-7 p-4">
                                ...
                                <form action="{{ route('contact.store') }}" method="post">
                                    ...
                                    <div class="form-group mb-2">
                                        <label class="font-weight-bold text-light small opacity-60 mb-1">Nombre
                                            Completo</label>
                                        <input type="text" name="nombre"
                                            class="form-control form-control-dark form-control-sm" required
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="mensaje" class="form-control form-control-dark form-control-sm"
                                            rows="3" required placeholder="Escribe tus comentarios..."></textarea>
                                    </div>

                                    <button type="submit"
                                        class="btn btn-warning btn-block py-2 rounded-pill shadow font-weight-bold transform-hover text-dark btn-sm">
                                        ENVIAR MENSAJE
                                    </button>
                                </form>
                            </div>
